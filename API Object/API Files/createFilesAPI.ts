...
async createDocument(name) {
    const response = await this.page.request.post('https://gb-auto-u-srv2.demo.zextras.io/services/docs/files/create', {
...
async getIdFromAllGroups() {
    const response = await this.page.request.post('https://gb-auto-u-srv2.demo.zextras.io/zx/team/v22/getConversations', {
        data: {}
        });
       const body = await this.GetResponceBody(response);
...
async leaveFromGroup() {
    const response = await this.page.request.post('https://gb-auto-u-srv2.demo.zextras.io/zx/team/v22/leaveConversation', {
...
async deleteGroup(konvid) {
    ...
    const responsea = await this.page.request.post('https://gb-auto-u-srv2.demo.zextras.io/zx/team/v22/kickFromConversation', {
        data: {conversation_id: konvid ,kicked_user_ids:["ea8f7cc4-54e7-407c-87ae-ba22764117c7"]}
        });
        await this.GetResponceBody(responsea);

         const responseb = await this.page.request.post('https://gb-auto-u-srv2.demo.zextras.io/zx/team/v22/leaveConversation', {
